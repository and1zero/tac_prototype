 ...
 *
 */
$env = is_file(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'env') ? trim(file_get_contents(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'env')) : 'development';
...
// Bootstrapping global configuration file
require_once FCPATH . 'config' . EXT;
