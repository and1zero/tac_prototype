...
<ul class="nav" role="navigation" >
	<li class="active" id="topmenu_1"><a href="http://localhost/tac_prototype/home">Home</a></li>
		<li class="last" id="topmenu_2" class="dropdown" ><a href="http://localhost/tac_prototype/about"  id="about2" class="dropdown-toggle" data-toggle="dropdown" role="button" data-target="#" >About<b class="caret"></b></a>
