...
<ul class="nav" role="navigation" >
	<li class="active" id="topmenu_1"><a href="http://localhost/tac_prototype/home"  id="home1" class="dropdown-toggle" data-toggle="dropdown" role="button" data-target="#" >Home</a></li>
		<li class="last" id="topmenu_2" class="dropdown" ><a href="http://localhost/tac_prototype/about"  id="about2" class="dropdown-toggle" data-toggle="dropdown" role="button" data-target="#" >About</a>
		<ul aria-labelledby="about2" class="dropdown-menu" role="menu" >
			<li id="topmenu_4"><a href="http://localhost/tac_prototype/about"  id="about_us4" class="dropdown-toggle" data-toggle="dropdown" role="button" data-target="#" >About Us</a></li>
				<li class="last" id="topmenu_3"><a href="http://localhost/tac_prototype/about/contact"  id="about_contact3" class="dropdown-toggle" data-toggle="dropdown" role="button" data-target="#" >Contact Us</a></li>
			</ul>
			</li>
	</ul>
	                        <!-- Navigation -->
